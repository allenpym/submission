...
Accuracy of tree model is not very satisfying. In order to improve it, random forest algorithm was applied. Out of sample error has been greatly reduced to 0.1%.
```{r}
